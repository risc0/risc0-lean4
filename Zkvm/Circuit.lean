...
def PolyExtStepDef.step [Field Elem] [Field ExtElem] [Algebra Elem ExtElem] (self: PolyExtStepDef) (mix: ExtElem) (u: Array ExtElem) (args: Array (Array Elem)): MixState ExtElem :=
